...
| Review regional QCEW vintages | [BLS QCEW regional vintages source record](data-sources/bls-qcew-regional-vintages.md) | State-total revisions, point-in-time selection, normalized fields, rights, and stopping conditions |
| Review archived state growth data | [BEA Regional Accounts archives source record](data-sources/bea-regional-accounts-archives.md) | Archived GDP and income releases, units, vintage rules, rights, and admission limits |
| Review archived state housing data | [FHFA state HPI archives source record](data-sources/fhfa-state-hpi-archives.md) | Purchase-only HPI scope, revision risk, PDF extraction, manual approval, and attribution |
...
| Review the v2 contract and current blocker | [Publisher-backed regional expert ensemble v2](experiments/regional-expert-ensemble-v2.md) | Typed boundaries, profiles, screened stacking, dynamic gating, and the QCEW feasible-date finding |
...
| Inspect planned v2 files | [Regional expert ensemble v2 artifact reference](reference/regional-artifacts-v2.md) | Indexed source artifacts, model outputs, hashes, and cross-language rules |
...
| Review economics ML practice | [Economics and finance machine learning guide](guides/economics-finance-machine-learning.md) | Prediction versus inference, temporal validation, regularization, leakage, ablations, and claim limits |
| Use AI in economics writing | [AI-assisted economic research and writing](guides/ai-assisted-economic-research-writing.md) | Licensed adaptation, 17 workflow categories, citation checks, privacy, identification, interpretation, and disclosure |
| Explore world-model research | [Economic world models as a separate research track](research/economic-world-models.md) | Agents, institutions, transitions, calibration, rollouts, evaluation, and simulation limits |
